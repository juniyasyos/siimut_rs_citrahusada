...
<?php endif; ?>
                        ...
                        <div>
                            <div class="flex flex-col justify-between border-t dark:border-gray-700 p-4">
                                <div>
                                    <h1 class="font-bold break-words"><?php echo e($item->hasCustomProperty('title') ? (!empty($item->getCustomProperty('title')) ? $item->getCustomProperty('title') : $item->name) : $item->name); ?></h1>
                                </div>
                ...
                <div>
                    <div class="flex flex-col justify-start w-full h-full">
                        ...
                        <?php if(str($item->mime_type)->contains('image')): ?>
                            <a href="<?php echo e($item->getUrl()); ?>" target="_blank" class="flex flex-col items-center justify-center  p-4 h-full border dark:border-gray-700 rounded-lg">
                                <img src="<?php echo e($item->getUrl()); ?>" />
                            </a>
...
<?php endif; ?>
                        ...
                        <div class="flex flex-col gap-4 my-4">
                            ...
                            <div>
                                <div>
                                    <h1 class="font-bold"><?php echo e(trans('filament-media-manager::messages.media.meta.model')); ?></h1>
                                </div>
                                <div class="flex justify-start">
                                    <p class="text-sm">
                            ...
                            <div>
                                <div>
                                    <h1 class="font-bold"><?php echo e(trans('filament-media-manager::messages.media.meta.file-name')); ?></h1>
                                </div>
                                <div class="flex justify-start">
                                    <p class="text-sm">
                                        <?php echo e($item->file_name); ?>
                            ...
                            <div>
                                <div>
                                    <h1 class="font-bold"><?php echo e(trans('filament-media-manager::messages.media.meta.type')); ?></h1>
                                </div>
                                <div class="flex justify-start">
                                    <p class="text-sm">
                            ...
                            <div>
                                <div>
                                    <h1 class="font-bold"><?php echo e(trans('filament-media-manager::messages.media.meta.size')); ?></h1>
                                </div>
                                <div class="flex justify-start">
                                    <p class="text-sm">
                            ...
                            <div>
                                <div>
                                    <h1 class="font-bold"><?php echo e(trans('filament-media-manager::messages.media.meta.disk')); ?></h1>
                                </div>
                                <div class="flex justify-start">
                                    <p class="text-sm">
...
<?php endif; ?>
<?php /**PATH /root/SI-IMUT/vendor/juniyasyos/filament-media-manager/resources/views/pages/media.blade.php ENDPATH**/ ?>