...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'filament-panels::components.avatar.user','data' => ['size' => 'xl','user' => $user]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl','user' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($user)]); ?>
...
<?php endif; ?>
        ...
        <form action="<?php echo e(filament()->getLogoutUrl()); ?>" method="post" class="my-auto flex justify-end">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /root/SI-IMUT/resources/views/filament/widgets/header-dasboard.blade.php ENDPATH**/ ?>